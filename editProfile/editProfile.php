            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="nev" id="nev" class="form-control" placeholder="Adja meg a nevét"
                            value="<?php echo $nev ?? ""; ?>">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Telefonszám:</span>
                        <div class="phone-prefix">+36</div>
                        <input type="tel" name="telefon" class="form-control" pattern="[0-9]*" maxlength="9"
                            id="telefon" placeholder="Adja meg a telefonszámát" value="<?php echo $telefon ?? ""; ?>">
                    </div>
                    <hr>
                    <h3>Céges adatok</h3>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Cég neve:</span>
                        <input type="text" name="cegNev" class="form-control" placeholder="Adja meg a cég nevét"
                            value="<?php echo $cegNev ?? ""; ?>">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Irányítószám:</span>
                        <input type="tel" name="irsz" class="form-control" placeholder="Adja meg a cég irányítószámát"
                            maxlength="4" minlength="4" pattern="[0-9]*" value="<?php echo $irsz ?? ""; ?>"
                            oninput="checkInputLength(this)">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Cím:</span>
                        <input type="text" name="cim" id="cim" class="form-control" placeholder="Adja meg a cég címét"
                            value="<?php echo $szekhely ?? ""; ?>">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Adószám:</span>
                        <input type="text" name="adoszam" pattern="[0-9]*" maxlength="11" minlength="11" id="adoszam"
                            class="form-control" placeholder="Adja meg a cég adószámát"
                            value="<?php echo $adoszam ?? ""; ?>">
                    </div>
                    <div class="input-group mb-3">
